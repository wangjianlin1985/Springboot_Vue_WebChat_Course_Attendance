<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-link type="primary" style="float: right;" @click.native="handleAdd">还没账号？立即注册</el-link>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="曾路账号" prop="userName">
          ...
          <el-col :span="12">
            <el-form-item label="所属角色">
              <el-select v-model="form.roleIds" placeholder="请选择">
                <el-option label="教师" value="100" ></el-option>
    ...
    <div class="el-login-footer">
      <span>Copyright © 2018-2021 bs.vip All Rights Reserved.</span>
    </div>
  </div>
</template>
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          addUser(this.form).then(response => {
            this.msgSuccess("账号注册成功，您可以新账号进行登录");
            this.open = false;
          });
        }
      });
